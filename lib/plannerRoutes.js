...
const { ID, REGIONS, TRAVEL, plain, validDate, text, fail, active, eventOccursOn, loadPlannerCatalog, recommend } = require('./planner');
...
const emptyAccount = () => ({ preferences: defaults(), favorites: [], plans: [], revision: 0, importedEvents: [], importedEventsRevision: 0 });
